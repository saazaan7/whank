...
function whank_setup() {
	...
	// Cropping images in different sizes
	add_image_size( 'whank-featured-post', 872, 500, true );
...
function whank_scripts() {
	...
	wp_enqueue_script( 'whank-custom-js', WHANK_JS_URL. '/whank'.$suffix.'.js', array('jquery'), '1.0', true );
}
