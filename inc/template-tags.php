...
if ( ! function_exists( 'whank_posted_on' ) ) :
/**
 * Prints HTML with meta information for the current post-date/time and author.
 */
function whank_posted_on() {
	...
	$byline = sprintf(
		...
		esc_html_x( 'by %s', 'post author', 'whank' ),
...
if ( ! function_exists( 'whank_entry_footer' ) ) :
/**
 * Prints HTML with meta information for the categories, tags and comments.
 */
function whank_entry_footer() {
	...
	if ( 'post' === get_post_type() ) {
		...
		/* translators: used between list items, there is a space after the comma */
		$tags_list = get_the_tag_list( '', esc_html_x( ', ', 'list item separator', 'whank' ) );
		if ( $tags_list ) {
	...
	edit_post_link(
		sprintf(
			wp_kses(
				...
				__( 'Edit <span class="screen-reader-text">%s</span>', 'whank' ),
				array(
					'span' => array(
						'class' => array(),
					),
